...
The scientific and technological progress in the fields of Artificial Intelligence and Robotics (AIR) has been rapidly moving forward over the past decade, specially in countries such as United States, China and Europe where support of such fields is part of their agenda \cite{Savage2020}. 
However, such support brings other challenges such as the little to none focus on a centered AIR for children as well as the challenge of making the fields of AIR available to under-represented communities.
In terms of a child-centered AIR, ...
Similarly, such technologies are unreachable to young audiences from under-represented communities as recently pointed out by United Nations Children's Fund (UNICEF) \cite{UNICEF2020}.
That said, this work is proposing Artificial Intelligence and Robotics for Children (AIR4Children) as a way to make AIR available to young audiences with perhaps limited resources and to creation and design tools based on open-sourced projects to address fairness and accessibility. 
...
For this work, section 2 review open source projects as a way to minimise cost for hardware and software as the basis of the material for AIR4Children which is presented in section 3. 
...
In 1978 Donald Knuth designed \TeX, typesetting system, which is a role model for open source projects where organisational phases of its development and the relative simple accessibility to users were crucial to its success \cite{gaudeul2007}.
Then, in 1983 Richard Stallman, with the frustration to not freely inspect, modify or share software, founded the GNU project to then create a GNU manifesto stating the freedom to run, study, copy, and make modification of software \cite{stallman1985}.
...
In the last decade, another wave of scientific innovation has been emerging in the field of AI due to open source software frameworks (e.g. pytorch, tensorflow, etc.) and places to distribute these (e.g. GitHub, gitlab, bitbucket) \cite{matelabs2017}
...
With regards to Robotics, the JPL Open Source Rover, created by engineers at NASA and initially released in April 2018, is a good reference as it is designed with detailed instructions for constructions for high school students and beyond, and technical specifications, 3D models, assembly instructions are fully available \cite{OSR:2018}.
...
That said, there is room to create platforms to create educational resources to teach AI and robotics, as pointed by JetBot, in a more affordable, educational and fun characteristics.
Table~\ref{tab:opensourceprojects} summarises three open source projects with year of establishment and cost.
...
On a third phase, children and adolescents in a range of age between 6 to 14 years old will be invited to enroll on workshops that will be free to all the participants. 
This initial phases of the project will help us to provide evidence of the impact of AIR in a children of different backgrounds and evaluate their perception on the fields of AI and Robotics.  
...
That said, figure \ref{fig:tm}(a) illustrate the spiral learning technique adopted for AIR4Children to reinforce the above Montessori skills \cite{tarik2017}.
