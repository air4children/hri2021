...
%]{biblatex}
%\usepackage{biblatex}
%\addbibresource{../references/references-simple.bib}
...
With regard to child-centered AIR, there is few materials and resources with poor accessible and not appropriately affordable.  
In terms of affordability, such technologies are unreachable to young audiences from under-represented communities as recently pointed out by United Nations Children's Fund (UNICEF) \cite{UNICEF2020}.
...
Such projects were the corner stone of what is known as the Open Software Initiative, founded by Bruce Perens and Eric S. Raymond in 1998, stating that projects must be free re distributable, code must be available and distributable, modification must be allowed, etc \cite{brasseur2018}.
...
\bibliography{../references/references-simple}
%\printbibliography
